  ...
  return (
    ...
    <div className={styles.mentionsLegalesContainer}>
      ...
      <p>
        ...
        <a href="https://www.mohairdesquatresaisons">
          https://www.mohairdesquatresaisons
        </a>{" "}
      ...
      <p>
        <strong>Propriétaire</strong> : EARL Les quatre saisons Capital social
        de 25 500,00 € Numéro de TVA: FR48418288650 – La maison neuve 85150
        Saint Julien des landes
        <br />
        <strong>Responsable publication</strong> : Bénédict Morineau –
        mohairdesquatresaisons@gmail.com
        <br />
        Le responsable publication est une personne physique ou une personne
        morale.
        <br />
        <strong>Webmaster</strong> : Lucas Nandan – lucas.nandan@gmail.com
        <br />
        <strong>Hébergeur</strong> : en attente – en attente 00000 en attente
        00000000
        <br />
        <strong>Délégué à la protection des données</strong> : bénédicte
        Morineau – mohairdesquatresaisons@gmail
        <br />
      </p>
      ...
      <p>
        ...
        responsable du traitement des Données Personnelles est : Les quatre
        saisons.{" "}
        <a href="https://www.mohairdesquatresaisons">
          https://www.mohairdesquatresaisons
        </a>
        est représenté par Bénédicte Morineau, son représentant légal
      </p>
      <p>
      ...
      Les quatre saisons – DPO, bénédicte Morineau <br />
      La maison neuve 85150 Saint Julien des landes.
      <p>
      ...
      <div ng-bind-html="rgpdHTML">
        ...
        <p>
          ...
          période maximale de 2 mois mois après la fin de la relation
          contractuelle:
          <br />
          adresse postale nom prénom adresse mail
        </p>
        <p>
          <a href="https://www.mohairdesquatresaisons">
            https://www.mohairdesquatresaisons
        ...
        <p>
          {" "}
          Ces &nbsp;données sont conservées pour une période maximale de 2 mois
      ...
      <p>
        ...
        compétents de La Roche-sur-yon
      </p>
    </div>
  );
}
